 ...
 */
abstract contract ERC20 is SphereXProtectedBase, Context, IERC20, IERC20Metadata, IERC20Errors {
  ...
  function transfer(
    address to,
    uint256 value
  ) public virtual sphereXGuardPublic(0xaf122465, 0xa9059cbb) returns (bool) {
  ...
  function approve(
    address spender,
    uint256 value
  ) public virtual sphereXGuardPublic(0xb5efce87, 0x095ea7b3) returns (bool) {
    address owner = _msgSender();
  ...
  function transferFrom(
    ...
    address to,
    uint256 value
  ) public virtual sphereXGuardPublic(0x31aeebe7, 0x23b872dd) returns (bool) {
  ...
  function _approve(
    ...
    uint256 value,
    bool emitEvent
  ) internal virtual sphereXGuardInternal(0xc29c6577) {
    if (owner == address(0)) {
  ...
  function _spendAllowance(
    ...
    address spender,
    uint256 value
  ) internal virtual sphereXGuardInternal(0xd01ab9a6) {
