...
/**
 * @title SteerStrategy
 * @notice A strategy contract for managing steer LP positions
 * @dev This strategy is a basic implementation that holds steer LP tokens without additional staking
 * It inherits from StrategyBase and overrides the required functions
 */
contract SteerStrategy is StrategyBase {
  /**
   * @notice Initializes the steer strategy
