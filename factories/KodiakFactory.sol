...
import {KodiakStrategy} from "../strategies/KodiakStrategy.sol";
...
/**
 * @title KodiakFactory
 * @notice Factory contract for deploying steer strategy vaults
 * @dev Inherits from StrategyFactoryBase and handles the creation of steer-specific vaults,
 * controllers and strategies
 */
contract KodiakFactory is StrategyFactoryBase {
  /// @notice Struct to hold Steer vault parameters
  struct KodiakVaultParams {
    address asset;
    address governance;
    address strategist;
    address timelock;
  ...
  /**
   * @notice Creates a new vault with a steer strategy
