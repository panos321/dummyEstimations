...
import {SteerStrategy} from "../strategies/SteerStrategy.sol";
 ...
 */
contract SteerFactory is StrategyFactoryBase {
  /// @notice Struct to hold Steer vault parameters
  struct SteerVaultParams {
    address asset;
    address governance;
    address strategist;
    address timelock;
  ...
  function createVaultWithParams(
    SteerVaultParams calldata params
  )
    external
    virtual
    onlyDev
